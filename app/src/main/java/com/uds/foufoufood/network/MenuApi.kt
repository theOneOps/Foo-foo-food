...
interface MenuApi {
    ...
    suspend fun getAllMenusByRestaurant(
        @Header("Authorization") token: String, @Path("restaurantId") restaurantId: String
    ...
    suspend fun createMenu(
        @Header("Authorization") token: String, @Body request: MenuRequest
    ): Response<MenuResponse>
    ...
    suspend fun deleteMenu(
        @Header("Authorization") token: String, @Path("menuId") menuId: String
    ): Response<MenuResponse>
}